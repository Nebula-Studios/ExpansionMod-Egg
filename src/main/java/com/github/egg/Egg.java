...
public class Egg extends JavaModAPI {
    ...
    public void onLoad(){
        ...
        this.registerEvents(new EggEvent());
    }

    @Override
    public void run(){
        this.getLogger().info("很好，我来搞事了！");
        this.getLogger().info(this.getConfig().getString("Egg"));
        eggs_init();
    }

    @Override
    public void stop(){
        this.getLogger().info("不！为什么关掉了！");
    }

    public void eggs_init(){
        this.getLogger().info("创建彩蛋ing...");
        ...
        createEgg("Remilia_marisa1", """
                ...
                84在上,yy在下,Ahas在偷看~
                """);
        this.getLogger().info("创建完成！awa");
    }

    private void createEgg(String name,String egg){
